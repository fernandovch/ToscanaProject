...
namespace ToscanaWebApp.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public ClienteController(ToscanaBDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Telefono,Direccion,Email")] Cliente cliente)
        {
